...
<header class="bg-primary-300 py-4">
  ...
  <nav class="flex justify-between items-center container">
    ...
    <ul class=" gap-10 items-center hidden xl:flex">
      ...
      <li><a href="#" class="text-white">Albergues</a></li>
      <li><a href="#" class="text-white">Blog</a></li>
      <li><a href="#" class="text-white">Animales Perdidos</a></li>
      <li><a href="#" class="btn btn--primary">Adoptar</a></li>
    </ul>
    <button class="text-white text-3xl xl:hidden"> <i class="fa-solid fa-bars"></i></button>
